...
class YOLO {
  ...
  public static let inputWidth = 832
  public static let inputHeight = 832
  public static let maxBoundingBoxes = 1

  // Tweak these values to get more or fewer predictions.
  let confidenceThreshold: Float = 0.85
  let iouThreshold: Float = 0.85
